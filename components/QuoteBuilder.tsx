...
export default function QuoteBuilder() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-3xl font-bold text-gray-800 text-right">Total Cost: ${totalCost.toFixed(2)}</div>
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <ItemForm onSubmit={editingItem ? updateItem : addItem} initialItem={editingItem} onCancel={closeModal} />
      </Modal>
    </div>
  )
}
